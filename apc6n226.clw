   ...
   INCLUDE('ABWINDOW.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('APC6N226.INC'),ONCE        !Local module procedure declarations
...
Trig_UpdateReturRanapPerTransNewNonBilling PROCEDURE       ! Generated from procedure template - Window
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  GlobalErrors.SetProcedureName('Trig_UpdateReturRanapPerTransNewNonBilling')
  ...
  INIMgr.Fetch('Trig_UpdateReturRanapPerTransNewNonBilling',QuickWindow) ! Restore window settings from non-volatile store
...
ReturnValue          BYTE,AUTO
  ...
  END
  IF SELF.Opened
    INIMgr.Update('Trig_UpdateReturRanapPerTransNewNonBilling',QuickWindow) ! Save window data to non-volatile store
  END
