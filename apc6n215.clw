   ...
   INCLUDE('ABWINDOW.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('APC6N215.INC'),ONCE        !Local module procedure declarations
                       ...
                       INCLUDE('APC6N216.INC'),ONCE        !Req'd for module callout resolution
                     END


Trig_BrowseReturRanapNewPerNotaSamaHarga PROCEDURE         ! Generated from procedure template - Window
...
ViewPosition           STRING(1024)                   !Entry's view position
                     END
QuickWindow          WINDOW('Pembatalan Transaksi Rawat Inap'),AT(,,457,205),FONT('Times New Roman',8,COLOR:Black,),IMM,HLP('Tran_Poliklinik'),SYSTEM,GRAY,RESIZE,MDI
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  GlobalErrors.SetProcedureName('Trig_BrowseReturRanapNewPerNotaSamaHarga')
  ...
  BRW1.SetFilter('((APH:N0_tran=glo::no_nota OR APH:N0_tran=GLO:NOBATAL) and APH:N0_tran<<>'''')') ! Apply filter expression to browse
  ...
  INIMgr.Fetch('Trig_BrowseReturRanapNewPerNotaSamaHarga',QuickWindow) ! Restore window settings from non-volatile store
...
ReturnValue          BYTE,AUTO
  ...
  END
  IF SELF.Opened
    INIMgr.Update('Trig_BrowseReturRanapNewPerNotaSamaHarga',QuickWindow) ! Save window data to non-volatile store
  END
...
ReturnValue          BYTE,AUTO
  ...
  ELSE
    ...
    EXECUTE Number
      Trig_UpdateReturRanapPerTransNewSamaHarga
