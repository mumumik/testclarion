   ...
   INCLUDE('ABREPORT.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('APC6N155.INC'),ONCE        !Local module procedure declarations
                     END


ProsesBarang PROCEDURE                                     ! Generated from procedure template - Process
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  GlobalErrors.SetProcedureName('ProsesBarang')
  ...
  INIMgr.Fetch('ProsesBarang',ProgressWindow)              ! Restore window settings from non-volatile store
...
ReturnValue          BYTE,AUTO
  ...
  END
  IF SELF.Opened
    INIMgr.Update('ProsesBarang',ProgressWindow)           ! Save window data to non-volatile store
  END
...
ReturnValue          BYTE,AUTO
  ...
  if sub(clip(HM_:NAMABARANG),1,1)<>'' then
