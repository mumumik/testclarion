   ...
   INCLUDE('ABREPORT.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('APC6N124.INC'),ONCE        !Local module procedure declarations
                     END


PrintTransRawatInap1CD PROCEDURE                           ! Generated from procedure template - Report
...
report               REPORT,AT(10,39,80,1961),PAPER(PAPER:USER,8250,32500),PRE(RPT),FONT('Arial',10,,),MM
                       HEADER,AT(10,7,80,32)
                         ...
                         STRING(@t04),AT(42,13),USE(APH:Jam),FONT('Arial',8,COLOR:Black,FONT:regular)
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  GlobalErrors.SetProcedureName('PrintTransRawatInap1CD')
  ...
  INIMgr.Fetch('PrintTransRawatInap1CD',ProgressWindow)    ! Restore window settings from non-volatile store
...
ReturnValue          BYTE,AUTO
  ...
  END
  IF SELF.Opened
    INIMgr.Update('PrintTransRawatInap1CD',ProgressWindow) ! Save window data to non-volatile store
  END
  ProgressMgr.Kill()
