   ...
   INCLUDE('ABREPORT.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('APC6N101.INC'),ONCE        !Local module procedure declarations
                     END


ProsesHargaFifoMitraKasih PROCEDURE                        ! Generated from procedure template - Process
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  GlobalErrors.SetProcedureName('ProsesHargaFifoMitraKasih')
  ...
  INIMgr.Fetch('ProsesHargaFifoMitraKasih',ProgressWindow) ! Restore window settings from non-volatile store
...
ReturnValue          BYTE,AUTO
  ...
  END
  IF SELF.Opened
    INIMgr.Update('ProsesHargaFifoMitraKasih',ProgressWindow) ! Save window data to non-volatile store
  END
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  vl_count+=1
  GBAR:Kode_brg     =clip(AFI:Kode_Barang)
