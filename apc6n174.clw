   ...
   INCLUDE('ABWINDOW.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('APC6N174.INC'),ONCE        !Local module procedure declarations
...
Trig_UpdateRawatInapBpjs PROCEDURE                         ! Generated from procedure template - Window
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  GlobalErrors.SetProcedureName('Trig_UpdateRawatInapBpjs')
  ...
  INIMgr.Fetch('Trig_UpdateRawatInapBpjs',QuickWindow)     ! Restore window settings from non-volatile store
...
ReturnValue          BYTE,AUTO
  ...
  END
  IF SELF.Opened
    INIMgr.Update('Trig_UpdateRawatInapBpjs',QuickWindow)  ! Save window data to non-volatile store
  END
