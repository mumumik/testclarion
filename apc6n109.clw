   ...
   INCLUDE('ABWINDOW.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('APC6N109.INC'),ONCE        !Local module procedure declarations
...
Trig_UpdateReturRanapNew PROCEDURE                         ! Generated from procedure template - Window
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  GlobalErrors.SetProcedureName('Trig_UpdateReturRanapNew')
  ...
  INIMgr.Fetch('Trig_UpdateReturRanapNew',QuickWindow)     ! Restore window settings from non-volatile store
...
ReturnValue          BYTE,AUTO
  ...
  END
  IF SELF.Opened
    INIMgr.Update('Trig_UpdateReturRanapNew',QuickWindow)  ! Save window data to non-volatile store
  END
