   ...
   INCLUDE('ABWINDOW.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('APC6N214.INC'),ONCE        !Local module procedure declarations
                       INCLUDE('APC6N063.INC'),ONCE        !Req'd for module callout resolution
                       INCLUDE('APC6N215.INC'),ONCE        !Req'd for module callout resolution
                     END


Trig_WindowReturRanapNewPerNotaSamaHarga PROCEDURE         ! Generated from procedure template - Window
...
window               WINDOW('Pembatalan Transaksi Rawat Inap'),AT(,,287,158),ICON('Vcrprior.ico'),GRAY,MDI,IMM
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  GlobalErrors.SetProcedureName('Trig_WindowReturRanapNewPerNotaSamaHarga')
  ...
  POST(EVENT:Disable_PembatalanRInap,,loc::thread)
  ...
  INIMgr.Fetch('Trig_WindowReturRanapNewPerNotaSamaHarga',window) ! Restore window settings from non-volatile store
  SELF.SetAlerts()
  RETURN ReturnValue
...
ReturnValue          BYTE,AUTO
  ...
  END
  IF SELF.Opened
    INIMgr.Update('Trig_WindowReturRanapNewPerNotaSamaHarga',window) ! Save window data to non-volatile store
  END
  POST(EVENT:Enable_PembatalanRInap,,loc::thread)
...
Looped BYTE
  ...
  LOOP                                                     ! This method receive all EVENT:Accepted's
    ...
    OF ?glo::no_nota
      ...
      IF ERRORCODE()
         ...
         if access:aphtrans.next()=level:benign then
          message('Nomor Transaksi sudah pernah dilakukan Retur/Retur Per Obat, silahkan coba menggunakan menu Retur Penjualan Pasien Rawat Inap ')
         else
    ...
    OF ?OkButton
      ...
      !Retur_rawat_jalan
      Trig_BrowseReturRanapNewPerNotaSamaHarga
