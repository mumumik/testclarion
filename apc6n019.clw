   ...
   INCLUDE('ABWINDOW.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('APC6N019.INC'),ONCE        !Local module procedure declarations
...
WindowAllTrans PROCEDURE                                   ! Generated from procedure template - Window
...
Window               WINDOW('All Transaksi Masuk'),AT(,,421,260),FONT('Arial',8,,FONT:regular),CENTER,GRAY,MDI
   ...
   '@16D|M~Tahun~L@n4@12D|M~Bulan~L@n3@'),FROM(Queue:Browse:6)
                           ...
                           BUTTON('Proses Stok Opname'),AT(253,222,77,14),USE(?Button9)
                         END
                       END
                       LIST,AT(9,18,402,79),USE(?List:11),IMM,VSCROLL,MSG('Browsing Records'),VCR,FORMAT('40L|M~Kode Barang~@s10@160L|M~Nama Obat~@s40@40L|M~Satuan~@s10@'),FROM(Queue:Browse:10)
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  GlobalErrors.SetProcedureName('WindowAllTrans')
  ...
  INIMgr.Fetch('WindowAllTrans',Window)                    ! Restore window settings from non-volatile store
...
ReturnValue          BYTE,AUTO
  ...
  END
  IF SELF.Opened
    INIMgr.Update('WindowAllTrans',Window)                 ! Save window data to non-volatile store
  END
...
Looped BYTE
  ...
  ReturnValue = PARENT.TakeAccepted()
    ...
    OF ?Button2
      ThisWindow.Update
      START(ProsesFIFOINSBBK, 25000)
      ThisWindow.Reset
    OF ?Button3
      ThisWindow.Update
      START(ProsesFIFOINRJual, 25000)
      ThisWindow.Reset
    OF ?Button4
      ThisWindow.Update
      START(ProsesFIFOINKeInstalasi, 25000)
      ThisWindow.Reset
    OF ?Button5
      ThisWindow.Update
      START(ProsesProduksiPlus, 25000)
      ThisWindow.Reset
    OF ?Button6
      ThisWindow.Update
      START(ProsesKoreksiPlus, 25000)
      ThisWindow.Reset
    OF ?Button7
      ThisWindow.Update
      START(ProsesDariApotikLain, 25000)
      ThisWindow.Reset
    OF ?Button8
      ThisWindow.Update
      START(ProsesDariSumedang, 25000)
      ThisWindow.Reset
    OF ?Button9
      ThisWindow.Update
      START(ProsesDariStokOpname, 25000)
      ThisWindow.Reset
    OF ?OkButton
      ThisWindow.Update
      break
...
ProsesFIFOINRJual PROCEDURE                                ! Generated from procedure template - Process
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  GlobalErrors.SetProcedureName('ProsesFIFOINRJual')
  SELF.Request = GlobalRequest                             ! Store the incoming request
  WindowTanggal12Apotik()
  ReturnValue = PARENT.Init()
  IF ReturnValue THEN RETURN ReturnValue.
  ...
  Do DefineListboxStyle
  INIMgr.Fetch('ProsesFIFOINRJual',ProgressWindow)         ! Restore window settings from non-volatile store
...
ReturnValue          BYTE,AUTO
  ...
  END
  IF SELF.Opened
    INIMgr.Update('ProsesFIFOINRJual',ProgressWindow)      ! Save window data to non-volatile store
  END
  GlobalErrors.SetProcedureName
  RETURN ReturnValue
...
ProsesFIFOINKeInstalasi PROCEDURE                          ! Generated from procedure template - Process
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  GlobalErrors.SetProcedureName('ProsesFIFOINKeInstalasi')
  SELF.Request = GlobalRequest                             ! Store the incoming request
  ReturnValue = PARENT.Init()
  WindowTanggal12Apotik()
  IF ReturnValue THEN RETURN ReturnValue.
  ...
  SELF.Open(ProgressWindow)                                ! Open window
  Do DefineListboxStyle
  INIMgr.Fetch('ProsesFIFOINKeInstalasi',ProgressWindow)   ! Restore window settings from non-volatile store
  ProgressWindow{Prop:Timer} = 10                          ! Assign timer interval
...
ReturnValue          BYTE,AUTO
  ...
  END
  IF SELF.Opened
    INIMgr.Update('ProsesFIFOINKeInstalasi',ProgressWindow) ! Save window data to non-volatile store
  END
  GlobalErrors.SetProcedureName
  RETURN ReturnValue
...
ProsesProduksiPlus PROCEDURE                               ! Generated from procedure template - Process
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  GlobalErrors.SetProcedureName('ProsesProduksiPlus')
  SELF.Request = GlobalRequest                             ! Store the incoming request
  WindowTanggal12Apotik()
  ReturnValue = PARENT.Init()
  IF ReturnValue THEN RETURN ReturnValue.
  ...
  SELF.Open(ProgressWindow)                                ! Open window
  Do DefineListboxStyle
  INIMgr.Fetch('ProsesProduksiPlus',ProgressWindow)        ! Restore window settings from non-volatile store
  ProgressWindow{Prop:Timer} = 10                          ! Assign timer interval
  ThisProcess.Init(Process:View, Relate:ApDProd, ?Progress:PctText, Progress:Thermometer)
  ThisProcess.AddSortOrder()
  ThisProcess.SetFilter('aphp:Tanggal>=vg_tanggal1 and aphp:Tanggal<<=vg_tanggal2 and aphp:kode_apotik=glo:apotik and apdp:kode_brg=glo_kode_barang')
  ProgressWindow{Prop:Text} = 'Processing Records'
  ?Progress:PctText{Prop:Text} = '0% Completed'
  SELF.Init(ThisProcess)
  ?Progress:UserString{Prop:Text}=''
...
ReturnValue          BYTE,AUTO
  ...
  END
  IF SELF.Opened
    INIMgr.Update('ProsesProduksiPlus',ProgressWindow)     ! Save window data to non-volatile store
  END
  GlobalErrors.SetProcedureName
  RETURN ReturnValue
...
ProsesKoreksiPlus PROCEDURE                                ! Generated from procedure template - Process
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  GlobalErrors.SetProcedureName('ProsesKoreksiPlus')
  SELF.Request = GlobalRequest                             ! Store the incoming request
  WindowTanggal12Apotik()
  ReturnValue = PARENT.Init()
  IF ReturnValue THEN RETURN ReturnValue.
  ...
  SELF.Open(ProgressWindow)                                ! Open window
  Do DefineListboxStyle
  INIMgr.Fetch('ProsesKoreksiPlus',ProgressWindow)         ! Restore window settings from non-volatile store
  ProgressWindow{Prop:Timer} = 10                          ! Assign timer interval
  ThisProcess.Init(Process:View, Relate:AAdjust, ?Progress:PctText, Progress:Thermometer)
  ThisProcess.AddSortOrder()
  ThisProcess.SetFilter('aad:Tanggal>=vg_tanggal1 and aad:Tanggal<<=vg_tanggal2 and aad:kode_apotik=glo:apotik and aad:status=1 and aad:kode_barang=glo_kode_barang')
  ProgressWindow{Prop:Text} = 'Processing Records'
  ?Progress:PctText{Prop:Text} = '0% Completed'
  SELF.Init(ThisProcess)
  ?Progress:UserString{Prop:Text}=''
...
ReturnValue          BYTE,AUTO
  ...
  END
  IF SELF.Opened
    INIMgr.Update('ProsesKoreksiPlus',ProgressWindow)      ! Save window data to non-volatile store
  END
  GlobalErrors.SetProcedureName
  RETURN ReturnValue
