   ...
   INCLUDE('ABWINDOW.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('APC6N221.INC'),ONCE        !Local module procedure declarations
                       INCLUDE('APC6N063.INC'),ONCE        !Req'd for module callout resolution
                       INCLUDE('APC6N222.INC'),ONCE        !Req'd for module callout resolution
                     END


Trig_WindowReturRanapNewPerMRNonBilling PROCEDURE          ! Generated from procedure template - Window
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  GlobalErrors.SetProcedureName('Trig_WindowReturRanapNewPerMRNonBilling')
  ...
  INIMgr.Fetch('Trig_WindowReturRanapNewPerMRNonBilling',window) ! Restore window settings from non-volatile store
  SELF.SetAlerts()
  RETURN ReturnValue
...
ReturnValue          BYTE,AUTO
  ...
  END
  IF SELF.Opened
    INIMgr.Update('Trig_WindowReturRanapNewPerMRNonBilling',window) ! Save window data to non-volatile store
  END
...
Looped BYTE
  ...
  LOOP                                                     ! This method receive all EVENT:Accepted's
    ...
    OF ?OkButton
      ...
      !Retur_rawat_jalan
      Trig_BrowseReturRanapNewPerMRNonBilling
