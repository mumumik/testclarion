   ...
   INCLUDE('ABWINDOW.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('APC6N213.INC'),ONCE        !Local module procedure declarations
...
Trig_BrowseBatalRawatJalanSamaHarga PROCEDURE              ! Generated from procedure template - Window
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  GlobalErrors.SetProcedureName('Trig_BrowseBatalRawatJalanSamaHarga')
  ...
  POST(EVENT:Disable_PembatalanRJalan,,loc::thread)
  ...
  INIMgr.Fetch('Trig_BrowseBatalRawatJalanSamaHarga',QuickWindow) ! Restore window settings from non-volatile store
...
ReturnValue          BYTE,AUTO
  ...
  END
  IF SELF.Opened
    INIMgr.Update('Trig_BrowseBatalRawatJalanSamaHarga',QuickWindow) ! Save window data to non-volatile store
  END
  POST(EVENT:Enable_PembatalanRJalan,,loc::thread)
  ...
  LOOP                                                     ! This method receive all EVENT:Accepted's
    ...
    OF ?Button9
      ...
      if access:aphtrans.next()=level:benign then
          ...
          cycle
      elsif APH:Biaya <0 or APH:NoTransaksiAsal<>'' then
