...
VAPHTRANS            FILE,DRIVER('SQLAnywhere'),NAME('dba.VAPHTRANS'),PRE(APH3),CREATE,BINDABLE,THREAD
mr_vaphtrans_fk          KEY(APH3:Nomor_mr),DUP,NOCASE,OPT
jtrans_vaphtrans_fk      KEY(APH3:NoNota),DUP,NOCASE,OPT
dokter_vaphtrans_fk      KEY(APH3:dokter),DUP,NOCASE,OPT
PK                       KEY(APH3:N0_tran),OPT,PRIMARY
apotik_vaphtrans_fk      KEY(APH3:Kode_Apotik),DUP,OPT
Tanggal_Vaphtrans_FK     KEY(APH3:Tanggal),DUP,NOCASE,OPT
Record                   RECORD,PRE()
Nomor_mr                    LONG
Tanggal                     DATE
Biaya                       REAL
...
transjum_apdtrans_fk     KEY(APD:N0_tran,APD:Jum1),DUP,NOCASE,OPT
Record                   RECORD,PRE()
N0_tran                     STRING(15)
Kode_brg                    STRING(10)
Jumlah                      REAL
...
TBTransResepDokterDetail_RI FILE,DRIVER('SQLAnywhere'),NAME('dba.TBTransResepDokterDetail_RI'),PRE(TBT5),CREATE,BINDABLE,THREAD
PK                       KEY(TBT5:NoTrans,TBT5:ItemCode),NOCASE,OPT,PRIMARY
Record                   RECORD,PRE()
NoTrans                     STRING(20)
ItemCode                    STRING(20)
ItemName                    STRING(100)
...
TBTransResepDokterDetail_RIHarian FILE,DRIVER('SQLAnywhere'),NAME('dba.TBTransResepDokterDetail_RIHarian'),PRE(TBT51),CREATE,BINDABLE,THREAD
PK                       KEY(TBT51:NoTrans,TBT51:Tanggal,TBT51:ItemCode),NOCASE,OPT,PRIMARY
ItemCode_TransRanapDetil_FK KEY(TBT51:ItemCode),DUP,NOCASE,OPT
Record                   RECORD,PRE()
NoTrans                     STRING(20)
ItemCode                    STRING(20)
ItemName                    STRING(100)
...
TBTransResepDokterHeader_RIPanggilRUang FILE,DRIVER('SQLAnywhere'),NAME('dba.TBTransResepDokterHeader_RIPanggilRUang'),PRE(TBT6),CREATE,BINDABLE,THREAD
PK                       KEY(TBT6:KodeRuang,TBT6:Tanggal,TBT6:Jam),NOCASE,OPT,PRIMARY
Record                   RECORD,PRE()
KodeRuang                   STRING(10)
Tanggal                     DATE
Jam                         TIME
Informasi                   STRING(100)
Status                      BYTE
Catatan                     STRING(100)
                         END
                     END                       
...
TBTransResepObatCampur_RI FILE,DRIVER('SQLAnywhere'),NAME('dba.TBTransResepObatCampur_RI'),PRE(TBT31),CREATE,BINDABLE,THREAD
PK                       KEY(TBT31:NoTrans,TBT31:ItemCode),NOCASE,OPT,PRIMARY
NoTransItem1_ObatCampurRanap_FK KEY(TBT31:NoTrans,TBT31:ItemCode1),DUP,NOCASE,OPT
Record                   RECORD,PRE()
NoTrans                     STRING(20)
ItemCode                    STRING(15)
ItemName                    STRING(100)
...
Access:VAPHTRANS     &FileManager,THREAD                   ! FileManager for VAPHTRANS
Relate:VAPHTRANS     &RelationManager,THREAD               ! RelationManager for VAPHTRANS
...
Access:TBTransResepDokterDetail_RI &FileManager,THREAD     ! FileManager for TBTransResepDokterDetail_RI
Relate:TBTransResepDokterDetail_RI &RelationManager,THREAD ! RelationManager for TBTransResepDokterDetail_RI
Access:TBTransResepDokterDetail_RIHarian &FileManager,THREAD ! FileManager for TBTransResepDokterDetail_RIHarian
Relate:TBTransResepDokterDetail_RIHarian &RelationManager,THREAD ! RelationManager for TBTransResepDokterDetail_RIHarian
...
Access:TBTransResepDokterHeader_RIPanggilRUang &FileManager,THREAD ! FileManager for TBTransResepDokterHeader_RIPanggilRUang
Relate:TBTransResepDokterHeader_RIPanggilRUang &RelationManager,THREAD ! RelationManager for TBTransResepDokterHeader_RIPanggilRUang
...
Access:TBTransResepObatCampur_RI &FileManager,THREAD       ! FileManager for TBTransResepObatCampur_RI
Relate:TBTransResepObatCampur_RI &RelationManager,THREAD   ! RelationManager for TBTransResepObatCampur_RI
...
lAdjFDSetting        LONG                                  ! ditto
  ...
  INIMgr.Init('apotik.INI', NVD_INI)                       ! Configure INIManager to use INI file
  DctInit
