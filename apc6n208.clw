   ...
   INCLUDE('ABWINDOW.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('APC6N208.INC'),ONCE        !Local module procedure declarations
...
Trig_UpdateReturRaJALNew PROCEDURE                         ! Generated from procedure template - Window
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  GlobalErrors.SetProcedureName('Trig_UpdateReturRaJALNew')
  ...
  INIMgr.Fetch('Trig_UpdateReturRaJALNew',QuickWindow)     ! Restore window settings from non-volatile store
...
ReturnValue          BYTE,AUTO
  ...
  END
  IF SELF.Opened
    INIMgr.Update('Trig_UpdateReturRaJALNew',QuickWindow)  ! Save window data to non-volatile store
  END
