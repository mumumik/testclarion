   ...
   INCLUDE('ABWINDOW.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('APC6N108.INC'),ONCE        !Local module procedure declarations
                       INCLUDE('APC6N064.INC'),ONCE        !Req'd for module callout resolution
                       INCLUDE('APC6N109.INC'),ONCE        !Req'd for module callout resolution
...
Trig_BrowseReturRanapNewPerMR PROCEDURE                    ! Generated from procedure template - Window
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  GlobalErrors.SetProcedureName('Trig_BrowseReturRanapNewPerMR')
  ...
  BRW1.SetFilter('(APH:nomor_mr=glo:mrfilter and aph:tanggal>=glo:tglfilter and sub(APH:N0_tran,1,3)=''API'' and APH:Kode_Apotik=GL_entryapotik)') ! Apply filter expression to browse
  ...
  INIMgr.Fetch('Trig_BrowseReturRanapNewPerMR',QuickWindow) ! Restore window settings from non-volatile store
...
ReturnValue          BYTE,AUTO
  ...
  END
  IF SELF.Opened
    INIMgr.Update('Trig_BrowseReturRanapNewPerMR',QuickWindow) ! Save window data to non-volatile store
  END
