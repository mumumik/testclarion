   ...
   INCLUDE('ABREPORT.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('APC6N200.INC'),ONCE        !Local module procedure declarations
                     END


PrintReturRawatJalan1Copy1 PROCEDURE                       ! Generated from procedure template - Report
...
detail1                  DETAIL,AT(,,184,8),USE(?detail1)
                           ...
                           STRING(@n15.2),AT(39,3,20,4),USE(APD:Diskon),RIGHT(2),FONT('Arial',8,,FONT:regular)
                         ...
                         FOOTER,AT(0,0,,29)
                           ...
                           STRING(@n15.2),AT(39,1,20,4),SUM,RESET(break1),USE(APD:Diskon,,?APD:Diskon:2),TRN,RIGHT(2),FONT('Arial',8,,FONT:regular)
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  GlobalErrors.SetProcedureName('PrintReturRawatJalan1Copy1')
  ...
  INIMgr.Fetch('PrintReturRawatJalan1Copy1',ProgressWindow) ! Restore window settings from non-volatile store
...
ReturnValue          BYTE,AUTO
  ...
  END
  IF SELF.Opened
    INIMgr.Update('PrintReturRawatJalan1Copy1',ProgressWindow) ! Save window data to non-volatile store
  END
  ProgressMgr.Kill()
