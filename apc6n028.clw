   ...
   INCLUDE('ABWINDOW.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('APC6N028.INC'),ONCE        !Local module procedure declarations
...
WindowAllTransKeluarPerAptk PROCEDURE                      ! Generated from procedure template - Window
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  GlobalErrors.SetProcedureName('WindowAllTransKeluarPerAptk')
  SELF.Request = GlobalRequest                             ! Store the incoming request
  ReturnValue = PARENT.Init()
  WindowTanggal12Apotik2()
  ...
  INIMgr.Fetch('WindowAllTransKeluarPerAptk',Window)       ! Restore window settings from non-volatile store
...
ReturnValue          BYTE,AUTO
  ...
  END
  IF SELF.Opened
    INIMgr.Update('WindowAllTransKeluarPerAptk',Window)    ! Save window data to non-volatile store
  END
...
Looped BYTE
  ...
  ReturnValue = PARENT.TakeAccepted()
    ...
    OF ?Button2
      ThisWindow.Update
      START(ProsesFIFOOUTBSBBK1, 25000)
      ThisWindow.Reset
    OF ?Button3
      ThisWindow.Update
      START(ProsesFIFOOUTJual1, 25000)
      ThisWindow.Reset
    OF ?Button4
      ThisWindow.Update
      START(ProsesFIFOOUTDrInstalasi1, 25000)
      ThisWindow.Reset
    OF ?Button5
      ThisWindow.Update
      START(ProsesProduksiKeluar1, 25000)
      ThisWindow.Reset
    OF ?Button6
      ThisWindow.Update
      START(ProsesKoreksiMinus1, 25000)
      ThisWindow.Reset
    OF ?Button7
      ThisWindow.Update
      START(ProsesKeApotikLain1, 25000)
      ThisWindow.Reset
    OF ?Button8
      ThisWindow.Update
      START(ProsesKeSumedang1, 25000)
      ThisWindow.Reset
    OF ?Button9
      ThisWindow.Update
      START(ProsesDrOutTempKeFIFOUT1, 25000)
      ThisWindow.Reset
    OF ?OkButton
      ThisWindow.Update
      break
...
ProsesFIFOOUTJual1 PROCEDURE                               ! Generated from procedure template - Process
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  GlobalErrors.SetProcedureName('ProsesFIFOOUTJual1')
  SELF.Request = GlobalRequest                             ! Store the incoming request
  ...
  Do DefineListboxStyle
  INIMgr.Fetch('ProsesFIFOOUTJual1',ProgressWindow)        ! Restore window settings from non-volatile store
...
ReturnValue          BYTE,AUTO
  ...
  END
  IF SELF.Opened
    INIMgr.Update('ProsesFIFOOUTJual1',ProgressWindow)     ! Save window data to non-volatile store
  END
  GlobalErrors.SetProcedureName
  RETURN ReturnValue
...
ProsesFIFOOUTDrInstalasi1 PROCEDURE                        ! Generated from procedure template - Process
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  GlobalErrors.SetProcedureName('ProsesFIFOOUTDrInstalasi1')
  SELF.Request = GlobalRequest                             ! Store the incoming request
  ReturnValue = PARENT.Init()
  WindowTanggal12Apotik()
  IF ReturnValue THEN RETURN ReturnValue.
  ...
  SELF.Open(ProgressWindow)                                ! Open window
  Do DefineListboxStyle
  INIMgr.Fetch('ProsesFIFOOUTDrInstalasi1',ProgressWindow) ! Restore window settings from non-volatile store
  ProgressWindow{Prop:Timer} = 10                          ! Assign timer interval
...
ReturnValue          BYTE,AUTO
  ...
  END
  IF SELF.Opened
    INIMgr.Update('ProsesFIFOOUTDrInstalasi1',ProgressWindow) ! Save window data to non-volatile store
  END
  GlobalErrors.SetProcedureName
  RETURN ReturnValue
...
ProsesProduksiKeluar1 PROCEDURE                            ! Generated from procedure template - Process
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  GlobalErrors.SetProcedureName('ProsesProduksiKeluar1')
  SELF.Request = GlobalRequest                             ! Store the incoming request
  WindowTanggal12Apotik()
  ReturnValue = PARENT.Init()
  IF ReturnValue THEN RETURN ReturnValue.
  ...
  SELF.Open(ProgressWindow)                                ! Open window
  Do DefineListboxStyle
  INIMgr.Fetch('ProsesProduksiKeluar1',ProgressWindow)     ! Restore window settings from non-volatile store
  ProgressWindow{Prop:Timer} = 10                          ! Assign timer interval
...
ReturnValue          BYTE,AUTO
  ...
  END
  IF SELF.Opened
    INIMgr.Update('ProsesProduksiKeluar1',ProgressWindow)  ! Save window data to non-volatile store
  END
  GlobalErrors.SetProcedureName
  RETURN ReturnValue
...
ProsesKoreksiMinus1 PROCEDURE                              ! Generated from procedure template - Process
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  GlobalErrors.SetProcedureName('ProsesKoreksiMinus1')
  SELF.Request = GlobalRequest                             ! Store the incoming request
  WindowTanggal12Apotik()
  ReturnValue = PARENT.Init()
  IF ReturnValue THEN RETURN ReturnValue.
  ...
  SELF.Open(ProgressWindow)                                ! Open window
  Do DefineListboxStyle
  INIMgr.Fetch('ProsesKoreksiMinus1',ProgressWindow)       ! Restore window settings from non-volatile store
  ProgressWindow{Prop:Timer} = 10                          ! Assign timer interval
  ThisProcess.Init(Process:View, Relate:AAdjust, ?Progress:PctText, Progress:Thermometer)
  ThisProcess.AddSortOrder()
  ThisProcess.SetFilter('aad:Tanggal>=vg_tanggal1 and aad:Tanggal<<=vg_tanggal2 and aad:kode_apotik=glo:apotik and aad:status=2')
  ProgressWindow{Prop:Text} = 'Processing Records'
  ?Progress:PctText{Prop:Text} = '0% Completed'
  SELF.Init(ThisProcess)
  ?Progress:UserString{Prop:Text}=''
...
ReturnValue          BYTE,AUTO
  ...
  END
  IF SELF.Opened
    INIMgr.Update('ProsesKoreksiMinus1',ProgressWindow)    ! Save window data to non-volatile store
  END
  GlobalErrors.SetProcedureName
  RETURN ReturnValue
