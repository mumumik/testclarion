   ...
   INCLUDE('ABREPORT.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('APC6N197.INC'),ONCE        !Local module procedure declarations
                     END


PrintTransRawatJalanA5copy1 PROCEDURE                      ! Generated from procedure template - Report
...
detail1                  DETAIL,AT(,,108,4),USE(?detail1)
                           ...
                           STRING(@s10),AT(88,0),USE(vl_keterangan),FONT('Times New Roman',8,,FONT:regular,CHARSET:ANSI)
                         ...
                         FOOTER,AT(0,0,,17),FONT('Times New Roman',8,,FONT:regular)
                           ...
                           LINE,AT(0,0,105,0),USE(?Line9),COLOR(COLOR:Black)
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  GlobalErrors.SetProcedureName('PrintTransRawatJalanA5copy1')
  ...
  INIMgr.Fetch('PrintTransRawatJalanA5copy1',ProgressWindow) ! Restore window settings from non-volatile store
...
ReturnValue          BYTE,AUTO
  ...
  END
  IF SELF.Opened
    INIMgr.Update('PrintTransRawatJalanA5copy1',ProgressWindow) ! Save window data to non-volatile store
  END
  ProgressMgr.Kill()
