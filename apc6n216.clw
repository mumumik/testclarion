   ...
   INCLUDE('ABWINDOW.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('APC6N216.INC'),ONCE        !Local module procedure declarations
...
Trig_UpdateReturRanapPerTransNewSamaHarga PROCEDURE        ! Generated from procedure template - Window
...
QuickWindow          WINDOW('Pembatalan Transaksi Rawat Inap'),AT(,,456,221),FONT('Times New Roman',8,COLOR:Black,),CENTER,IMM,HLP('UpdateAPHTRANS'),ALRT(EscKey),TIMER(100),GRAY,RESIZE,MDI
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  GlobalErrors.SetProcedureName('Trig_UpdateReturRanapPerTransNewSamaHarga')
  ...
  INIMgr.Fetch('Trig_UpdateReturRanapPerTransNewSamaHarga',QuickWindow) ! Restore window settings from non-volatile store
...
ReturnValue          BYTE,AUTO
  ...
  END
  IF SELF.Opened
    INIMgr.Update('Trig_UpdateReturRanapPerTransNewSamaHarga',QuickWindow) ! Save window data to non-volatile store
  END
