   ...
   INCLUDE('ABREPORT.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('APC6N199.INC'),ONCE        !Local module procedure declarations
                     END


PrintReturRawatJalanCopy1 PROCEDURE                        ! Generated from procedure template - Report
...
report               REPORT,AT(10,37,80,2000),PAPER(PAPER:USER,8250,20000),PRE(RPT),FONT('Arial',10,,),MM
                       HEADER,AT(10,7,80,28)
                         STRING('Ins. Farmasi RSI - RETUR R. Jalan -'),AT(2,1,45,5),USE(?String11),TRN,FONT('Times New Roman',8,,FONT:regular)
                         ...
                         STRING(@n1),AT(54,13,5,5),USE(APH:cara_bayar)
...
detail1                  DETAIL,AT(,,184,8),USE(?detail1)
                           ...
                           STRING(@n-15.2),AT(39,3,20,4),USE(APD:Diskon),RIGHT(2),FONT('Arial',8,,FONT:regular)
                         ...
                         FOOTER,AT(0,0,,29)
                           ...
                           STRING(@n-15.2),AT(39,1,20,4),SUM,RESET(break1),USE(APD:Diskon,,?APD:Diskon:2),TRN,RIGHT(2),FONT('Arial',8,,FONT:regular)
                           ...
                           STRING('(.{26})'),AT(19,20),USE(?String28:3),TRN,FONT('Times New Roman',8,,)
                           ...
                           STRING(@n-15.2),AT(37,6,20,4),USE(APH:Biaya),TRN,RIGHT,FONT('Times New Roman',8,,FONT:regular)
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  GlobalErrors.SetProcedureName('PrintReturRawatJalanCopy1')
  ...
  INIMgr.Fetch('PrintReturRawatJalanCopy1',ProgressWindow) ! Restore window settings from non-volatile store
...
ReturnValue          BYTE,AUTO
  ...
  END
  IF SELF.Opened
    INIMgr.Update('PrintReturRawatJalanCopy1',ProgressWindow) ! Save window data to non-volatile store
  END
  ProgressMgr.Kill()
