   ...
   INCLUDE('ABWINDOW.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('APC6N228.INC'),ONCE        !Local module procedure declarations
                       ...
                       INCLUDE('APC6N229.INC'),ONCE        !Req'd for module callout resolution
                     END


Trig_BrowseReturRawatJalanNonBilling PROCEDURE             ! Generated from procedure template - Window
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  GlobalErrors.SetProcedureName('Trig_BrowseReturRawatJalanNonBilling')
  ...
  BRW1.SetFilter('(APH:NoNota=glo:nota_retur and sub(APH:N0_tran,1,3)=''APO'' and APH:Ra_jal=1)') ! Apply filter expression to browse
  ...
  INIMgr.Fetch('Trig_BrowseReturRawatJalanNonBilling',QuickWindow) ! Restore window settings from non-volatile store
...
ReturnValue          BYTE,AUTO
  ...
  END
  IF SELF.Opened
    INIMgr.Update('Trig_BrowseReturRawatJalanNonBilling',QuickWindow) ! Save window data to non-volatile store
  END
...
ReturnValue          BYTE,AUTO
  ...
  ELSE
    ...
    EXECUTE Number
      Trig_UpdateReturRawatJalanNonBilling
