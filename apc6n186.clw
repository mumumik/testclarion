   ...
   INCLUDE('ABWINDOW.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('APC6N186.INC'),ONCE        !Local module procedure declarations
...
Trig_UpdateReturRawatInapPerTrans PROCEDURE                ! Generated from procedure template - Window
...
QuickWindow          WINDOW('Pengembalian obat Rawat Jalan ke Instalasi Farmasi'),AT(,,456,221),FONT('Times New Roman',8,,),CENTER,IMM,HLP('UpdateAPHTRANS'),ALRT(EscKey),TIMER(100),GRAY,RESIZE,MDI
   ...
   'M~N 0 tran~C(0)@s15@'),FROM(Queue:Browse:4)
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  GlobalErrors.SetProcedureName('Trig_UpdateReturRawatInapPerTrans')
  ...
  INIMgr.Fetch('Trig_UpdateReturRawatInapPerTrans',QuickWindow) ! Restore window settings from non-volatile store
...
ReturnValue          BYTE,AUTO
  ...
  END
  IF SELF.Opened
    INIMgr.Update('Trig_UpdateReturRawatInapPerTrans',QuickWindow) ! Save window data to non-volatile store
  END
