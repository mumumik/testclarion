   ...
   INCLUDE('ABREPORT.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('APC6N162.INC'),ONCE        !Local module procedure declarations
                       INCLUDE('APC6N004.INC'),ONCE        !Req'd for module callout resolution
                     END


PrintTransRawatInapA5 PROCEDURE                            ! Generated from procedure template - Report
...
break1                 BREAK(LOC::KOSONG)
                         HEADER,AT(0,0,,23),FONT('Times New Roman',8,,,CHARSET:ANSI)
                           ...
                           STRING('Jumlah'),AT(93,18,10,4),TRN,FONT('Times New Roman',8,COLOR:Black,)
...
detail1                  DETAIL,AT(,,193,4),USE(?detail1)
                           STRING(@n5.1),AT(93,0,,4),USE(APD:Jumlah),TRN,LEFT,FONT('Times New Roman',8,,)
                         ...
                         END
                         FOOTER,AT(0,0,,7),FONT('Times New Roman',8,,FONT:regular)
                           ...
                           STRING('Total : Rp.'),AT(74,0,16,4),USE(?String17),TRN,FONT('Times New Roman',8,COLOR:Black,)
                           LINE,AT(1,0,189,0),USE(?Line9),COLOR(COLOR:Black)
                           STRING(@N-15.2),AT(107,0,,4),USE(vl_total),TRN,RIGHT,FONT('Times New Roman',8,,)
                           STRING('Terbilang :'),AT(74,3,16,4),USE(?String17:2),TRN,FONT('Times New Roman',8,COLOR:Black,)
                           STRING(@s100),AT(88,3,,4),USE(vl_totalhuruf),TRN,FONT('Times New Roman',8,,,CHARSET:ANSI)
                         END
                       END
                     END
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  GlobalErrors.SetProcedureName('PrintTransRawatInapA5')
  ...
  INIMgr.Fetch('PrintTransRawatInapA5',ProgressWindow)     ! Restore window settings from non-volatile store
...
ReturnValue          BYTE,AUTO
  ...
  END
  IF SELF.Opened
    INIMgr.Update('PrintTransRawatInapA5',ProgressWindow)  ! Save window data to non-volatile store
  END
  ProgressMgr.Kill()
