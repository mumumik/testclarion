   ...
   INCLUDE('ABREPORT.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('APC6N146.INC'),ONCE        !Local module procedure declarations
                     END


Print_ReturRawatInap PROCEDURE                             ! Generated from procedure template - Report
...
report               REPORT,AT(10,37,80,2000),PAPER(PAPER:USER,8250,20000),PRE(RPT),FONT('Arial',10,,),MM
                       HEADER,AT(10,7,80,28)
                         STRING('Ins. Farmasi RSI - RETUR Rawat Inap -'),AT(2,1,47,5),USE(?String11),TRN,FONT('Times New Roman',8,,FONT:regular)
                         ...
                         STRING(@s20),AT(35,5,21,5),USE(ITbr:NAMA_RUANG),FONT(,8,,)
                         STRING(@s10),AT(36,9,17,5),USE(APH:Asal),HIDE,FONT('Times New Roman',8,,FONT:regular)
                         ...
                         STRING(@t04),AT(42,13),USE(vl_jam),TRN,FONT('Arial',8,,FONT:regular)
                         ...
                         STRING(@s5),AT(49,1,9,4),USE(GL_entryapotik),TRN,FONT('Times New Roman',8,,FONT:regular)
...
detail1                  DETAIL,AT(,,184,8),USE(?detail1)
                           ...
                           STRING(@n-15.2),AT(39,3,17,5),USE(APD:Diskon),RIGHT,FONT('Arial',8,,FONT:regular)
                         ...
                         FOOTER,AT(0,0,,29)
                           ...
                           STRING(@n-15.2),AT(39,1,17,4),SUM,RESET(break1),USE(APD:Diskon,,?APD:Diskon:2),TRN,RIGHT,FONT('Arial',8,,FONT:regular)
                           STRING('Petugas Apotik'),AT(8,12),USE(?String27),TRN,FONT('Times New Roman',8,,)
                           STRING('Diterima Oleh,'),AT(32,12,19,5),USE(?String27:2),TRN,FONT('Times New Roman',8,,)
                           ...
                           STRING(@s100),AT(2,24),USE(JKon:NAMA_KTR),FONT('Arial',8,,FONT:regular)
                           ...
                           STRING(@n-14.2),AT(36,6,20,4),USE(APH:Biaya),TRN,RIGHT,FONT('Times New Roman',8,,FONT:regular)
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  GlobalErrors.SetProcedureName('Print_ReturRawatInap')
  ...
  INIMgr.Fetch('Print_ReturRawatInap',ProgressWindow)      ! Restore window settings from non-volatile store
...
ReturnValue          BYTE,AUTO
  ...
  END
  IF SELF.Opened
    INIMgr.Update('Print_ReturRawatInap',ProgressWindow)   ! Save window data to non-volatile store
  END
  ProgressMgr.Kill()
