   ...
   INCLUDE('ABREPORT.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('APC6N202.INC'),ONCE        !Local module procedure declarations
                     END


PrintTransRawatInapA5copy2 PROCEDURE                       ! Generated from procedure template - Report
...
report               REPORT,AT(5,46,192,141),PAPER(PAPER:USER,4740,7890),PRE(RPT),FONT('Arial',10,,),MM
                       HEADER,AT(5,7,192,39),FONT('Times New Roman',8,,FONT:regular)
                         STRING('RS. Sartika Asih - Apotik'),AT(2,1,45,4),USE(?String11),TRN,FONT('Times New Roman',8,,FONT:regular)
                         ...
                         BOX,AT(1,34,188,5),COLOR(COLOR:Black)
                         ...
                         STRING('Keterangan'),AT(89,34,16,4),USE(?String36),TRN,FONT('Times New Roman',8,COLOR:Black,)
...
detail1                  DETAIL,AT(,,108,4),USE(?detail1)
                           ...
                           STRING(@s10),AT(89,0),USE(vl_keterangan),LEFT,FONT('Times New Roman',8,,FONT:regular,CHARSET:ANSI)
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  GlobalErrors.SetProcedureName('PrintTransRawatInapA5copy2')
  ...
  INIMgr.Fetch('PrintTransRawatInapA5copy2',ProgressWindow) ! Restore window settings from non-volatile store
...
ReturnValue          BYTE,AUTO
  ...
  END
  IF SELF.Opened
    INIMgr.Update('PrintTransRawatInapA5copy2',ProgressWindow) ! Save window data to non-volatile store
  END
  ProgressMgr.Kill()
