   ...
   INCLUDE('ABREPORT.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('APC6N198.INC'),ONCE        !Local module procedure declarations
                     END


PrintTransRawatInapA5copy1 PROCEDURE                       ! Generated from procedure template - Report
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  GlobalErrors.SetProcedureName('PrintTransRawatInapA5copy1')
  ...
  INIMgr.Fetch('PrintTransRawatInapA5copy1',ProgressWindow) ! Restore window settings from non-volatile store
...
ReturnValue          BYTE,AUTO
  ...
  END
  IF SELF.Opened
    INIMgr.Update('PrintTransRawatInapA5copy1',ProgressWindow) ! Save window data to non-volatile store
  END
  ProgressMgr.Kill()
