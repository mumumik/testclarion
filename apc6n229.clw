   ...
   INCLUDE('ABWINDOW.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('APC6N229.INC'),ONCE        !Local module procedure declarations
...
Trig_UpdateReturRawatJalanNonBilling PROCEDURE             ! Generated from procedure template - Window
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  GlobalErrors.SetProcedureName('Trig_UpdateReturRawatJalanNonBilling')
  ...
  INIMgr.Fetch('Trig_UpdateReturRawatJalanNonBilling',QuickWindow) ! Restore window settings from non-volatile store
...
ReturnValue          BYTE,AUTO
  ...
  END
  IF SELF.Opened
    INIMgr.Update('Trig_UpdateReturRawatJalanNonBilling',QuickWindow) ! Save window data to non-volatile store
  END
