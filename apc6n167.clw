   ...
   INCLUDE('ABWINDOW.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('APC6N167.INC'),ONCE        !Local module procedure declarations
                       ...
                       INCLUDE('APC6N174.INC'),ONCE        !Req'd for module callout resolution
                       INCLUDE('APC6N175.INC'),ONCE        !Req'd for module callout resolution
                     END


Trig_BrowseRawatInapBpjs PROCEDURE                         ! Generated from procedure template - Window
...
ViewPosition           STRING(1024)                   !Entry's view position
                     END
QuickWindow          WINDOW('Transaksi Instalasi Farmasi - Rawat Inap BPJS'),AT(,,532,309),FONT('Arial',8,,),CENTER,IMM,HLP('Tran_Poliklinik'),MSG('Transaksi Instalasi Farmasi'),SYSTEM,GRAY,MDI
...
ReturnValue          BYTE,AUTO
  ...
  CODE
  GlobalErrors.SetProcedureName('Trig_BrowseRawatInapBpjs')
  ...
  INIMgr.Fetch('Trig_BrowseRawatInapBpjs',QuickWindow)     ! Restore window settings from non-volatile store
...
ReturnValue          BYTE,AUTO
  ...
  END
  IF SELF.Opened
    INIMgr.Update('Trig_BrowseRawatInapBpjs',QuickWindow)  ! Save window data to non-volatile store
  END
